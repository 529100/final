...
<div class="panel admin-panel margin-top">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="/annc/save">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="field field-icon-right">
                        <input type="text" class="input input-big" name="title"/><br><%--Departments类--%>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="field field-icon-right">
                        <textarea name="content" rows="10" cols="40"></textarea><br><%--Departments类--%>
                        <%--                        <span class="icon icon-user margin-small"></span>--%>
                    </div>
                </div>
            </div>
